        ...
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <div class="content-box-large">
             ...
             <div class="content-box-large">
                <div class="panel-heading">
                    <div class="panel-title">Vos recherches enregistrées</div>
                </div>
                <div class="panel-body">
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th>Critères et Mots clés</th>
                            </tr>
                          </thead>
                          <tbody>

                          @foreach($liste as $sauv)
                            <tr>
                              <td class="center"> <img class="img-responsive" src="images/{!! $sauv->urlimage1 !!}" alt="jean Delacroix" width="60" height="45"> </td>
                              <td>{!! $sauv->nom !!}</td>
                              <td>{!! $sauv->description !!}</td>
                              <td>{!! $sauv->prix !!}</td>
                              <td class="center">{!! $sauv->DATE_SAUVEGARDE!!}</td>
                              <td class="center"><a class="btn btn-warning btn-xs" href="{{url('/produit/'.$sauv->slug)}}"> revisiter</a></td>
                              <td>{!! $sauv->MOTCLE !!}</td>
                            </tr>
                           @endforeach
