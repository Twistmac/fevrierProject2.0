function zoogooglemaps_init(key)
{
	...
	if (typeof key == "undefined")
		script.src = "//maps.googleapis.com/maps/api/js?key=" + key + "&sensor=false&callback=zoogooglemaps";
	else
		script.src = "//maps.googleapis.com/maps/api/js?sensor=false&callback=zoogooglemaps";
