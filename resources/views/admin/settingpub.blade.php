                            ...
                            <div class="row-fluid">
                                ...
                                data-upload-template-id="template-upload-1" data-download-template-id="template-download-1">
										            ...
										            <h4 class="simple-header"> Image d'illustration de la publicité <small>Taille standard</small> </h4>
												        ...
												        <div class="modal-footer"> <button data-dismiss="modal" class="btn btn-boo">Annuler</button> <button type="submit" class="btn btn-green">Ajouter la publicité</button> </div>
												        </form>
										    	</div>
										    <!-- // sample modal - stack ========================  -->
