                        ...
                        <div class="col-xs-12 col-lg-11 adv-search-icons">
                            <ul class="nav nav-tabs adv-search-tabs" role="tablist">
                                <li role="presentation" class="active" data-toggle="tooltip" data-placement="top" title="Résidentiel">
                                    <a href="#" aria-controls="apartments" role="tab" data-toggle="tab" id="adv-search-tab1"><i class="fa fa-building"></i></a>
                                </li>
                                <li role="presentation" data-toggle="tooltip" data-placement="top" title="Foncier">
                                    <a href="#" aria-controls="houses" role="tab" data-toggle="tab" id="adv-search-tab2"><i class="fa fa-home"></i></a>
                                </li>
                                <li role="presentation" data-toggle="tooltip" data-placement="top" title="Industriel">
                                    <a href="#" aria-controls="commercials" role="tab" data-toggle="tab" id="adv-search-tab3"><i class="fa fa-industry"></i></a>
                                </li>
                                <li role="presentation" data-toggle="tooltip" data-placement="top" title="Commercial">
                                    <a href="#" aria-controls="lands" role="tab" data-toggle="tab" id="adv-search-tab4"><i class="fa fa-tree"></i></a>
                                </li>
                            </ul>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-7">
            ...
            <section class="property-meta-wrapper common text-center bg-info">
                ...
                <a class="btn" href="#">
                    <img src="{!! URL::asset('images/iso-btn.png') !!}" alt="ISO Button">
                </a>
                <a class="btn" href="#">
                    <img src="{!! URL::asset('images/playstore-btn.png') !!}" alt="Play Store Button">
                </a>
            </section>
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="feature clearfix">
                            <i class="icon"><img src="{!! URL::asset('images/features/1.png') !!}" alt="Feature Icon"></i>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="feature clearfix">
                            <i class="icon"><img src="{!! URL::asset('images/features/2.png') !!}" alt="Feature Icon"></i>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="feature clearfix">
                            <i class="icon"><img src="{!! URL::asset('images/features/3.png') !!}" alt="Feature Icon"></i>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="feature clearfix">
                            <i class="icon"><img src="{!! URL::asset('images/features/4.png') !!}" alt="Feature Icon"></i>
                        ...
                        <div class="property-contents clearfix">
                            ...
                            <div class="author-box clearfix">
                                <a href="#" class="author-img">
                                    <img src="assets/images/agents/1.jpg" alt="Agent Image">
                                </a>
            ...
            <section class="property-meta-wrapper common text-center bg-info">
                ...
                <p class="wow slideInRight" style="visibility: hidden; animation-name: none;">
                    ...
                    labore et dolore magna aliquan ut enim ad minim veniam.</p>
                <a class="btn" href="#">
                    <img src="assets/images/iso-btn.png" alt="ISO Button">
                </a>
                <a class="btn" href="#">
                    <img src="assets/images/playstore-btn.png" alt="Play Store Button">
                </a>
            </section>
            <section id="home-property-for-rent-listing">
                <header class="section-header home-section-header text-center">
