        ...
        <div id="main-content" class="main-content container-fluid">
            ...
            <div id="page-content" class="page-content">
                <section>
                    ...
                    <div class="row-fluid">
                            <div class="well well-nice">
                                ...
                                <div class="control-group">
                                    <textarea id="wysiBooEditor" class="input-block-level" style="height: 560px" name="blog_paragraphe" placeholder="Enter text ...">{{$resultats->contenu}}</textarea>
                                </div>
                            </div>
                    </div>
                </section>
                ...
                <section>
                    ...
                    <input id="metaArticleKeywords" class="span4" type="text" name="metaArticleKeywords" value="{{$resultats->tag}}" /> 
                                    ...
                                    <div class="well well-nice inline">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-preview thumbnail" style="width: 200px; height: 120px;">
                                            	<img src="{{url('/images/'.$resultats->urlimage1)}}">
                                            </div>
